...
export default function MainMenu() {
    ...
    return <main className="menu-screen">
        ...
        <div className="menu-copy">
            ...
            <p>{story.intro}</p>
            <div className="how-to"><span>01</span> Release cars. Keep crossing paths apart.<br/><span>02</span> Emergency vehicles never wait for approval.<br/><span>03</span> Mistakes happen. Recover and keep working.</div>
